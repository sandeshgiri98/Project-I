        ...
        <main>
            ...
            <div class="page-content">
                ...
                <div class="analytics">
                    ...
                    <div class="card">
                        <a class="redirect_profile" href="../dashboard_a/solved_comp.php">
                            <div class="card-head">
                                <?php
                    ...
                    <div class="card">
                        <a class="redirect_profile" href="../dashboard_a/assigned_comp.php">
                            <div class="card-head">
                                <div class="main">
                                    <?php
                include_once('../connection/connection.php');
    ...
    ?>
                ...
                ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="redirect_profile" href="../dashboard_a/complaint_details.php">
                                            <div class="client">
                                                <?php
