                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($selectExe)) {
                            ...
                            if ($rowRole !== "super admin" && $userId !== $currentUserId) {
                                ?>
                                <tr>
                                    ...
                                    <td class="crude" style="display: flex; gap:10px;">
                                        <button onclick="window.location.href='../crude_a/update.php?id=<?php echo $row['id'] ?>'">Update</button>
                                        <?php
