    ...
    <div class="main-content">
        <div class="containers">
            <div class="product-details">
                <div class="product-adding-form">
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active"><b>Discharge Complaints</b></li>
                    </ol>
                </div>
            </div>
            <?php
            ...
            <table class="table">
                ...
                <?php
                $serialNumber = 1;
                while ($row = mysqli_fetch_assoc($dischargeExe)) {
                    ?>
                <tr class="view_com">
                    ...
                    <td style="width:90px;">
                        <select class="status-dropdown" data-complain-id="<?php echo $row['id']; ?>" disabled>
            ...
            <?php
            if (mysqli_num_rows($dischargeExe) > 0) {
            ?>
            <table class="table">
            ...
            <div class="product-details">
                <div class="product-adding-form">
                    <div style="padding: 30px; background-color: rgb(125, 124, 124); color:rgb(241, 239, 239);">
                        <li class="breadcrumb-item active"><b>There is no any Discharge Complaints</b></li>
                    </div>
                </div>
            </div>
            <?php
        ...
        ?>
            ...
            <div class="product-details">
                <div class="product-adding-form">
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active"><b>Solved Complaints</b></li>
                    </ol>
                </div>
            </div>
            <?php
            ...
            <table class="table">
                ...
                <?php
                $serialNumber = 1;
                while ($row = mysqli_fetch_assoc($solveExe)) {
                    ?>
                <tr class="view_com">
                    <td style="text-align: center; color:black; width:50px;"><?php echo $serialNumber; ?></td>
                    <td style="text-align: center; width:100px;"><?php echo $row['complain_user'] ?></td>
        ...
        if (mysqli_num_rows($solveExe) > 0) {
            ...
            <div class="product-details">
                <div class="product-adding-form">
                    <div style="padding: 30px; background-color: rgb(125, 124, 124); color:rgb(241, 239, 239);">
                        <li class="breadcrumb-item active"><b>There is no any Solved Complaints</b></li>
                    </div>
                </div>
            </div>
            <?php
