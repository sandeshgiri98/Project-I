...
<head>
    ...
    <link rel="stylesheet" href="../profile_a/form.css">
</head>
                     ...
                     <div class="product-details">
                                                ...
                                                <div class="pp_setting">
                                                    ...
                                                    <div class="upload_photo">
                                                            <form action="" method="POST" id="deleteProfileForm"
                                                                enctype="multipart/form-data">
                                                                <input type="button" value="Delete Profile Picture"
                                                                    style="text-align:center; margin-top:6px; background:red;"
                                                                    name="delete_profile_picture" class="button"
                                                                    id="deleteProfileBtn" />
                                                            </form>
                                                        </div>
                                                        <!-- <div class="upload_photo">
                                                        <form action="redirect.php" method="POST" id="product_form"
                                                            enctype="multipart/form-data">
                                                            <br />
                                                            <input type="submit" value="Delete Profile Picture" style="text-align:center; background:red;" name="delete_profile_picture" class="button" />
                                                            <input type="delete" value="Delete" style="text-align:center; background:red;" name="delete"
                                                                class="button" id="deleteProfileBtn" disabled /> 
                                                        </form>
                                                    </div> -->
                                                        </td>
                                                    </div>
                        ...
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            deleteProfileBtn.addEventListener("click", function() {
                                // Send an AJAX request to delete_profile_picture.php
                                ...
                                xhr.onreadystatechange = function() {
                                    if (xhr.readyState === 4 && xhr.status === 200) {
                                        ...
                                        alert(response); // Show an alert with the server's response

                                        // You can also add logic to update the page if needed

                                        // Reload the page after the profile picture is deleted
                                        location.reload();
                                    }
                                };
