...
if (isset($_POST['submit'])) {
    ...
    if ($updateResult) {
        ...
        echo "<script>alert('User Updated Successfully!'); window.location.href='../dashboard/userdetails.php';</script>";
    } else {
        // Failed to update data
        echo "<script>alert('Failed to update user.'); window.location.href='../dashboard/userdetails.php';</script>";
    }
}
    ...
    <div class="form-content">
        <form id="registration-form" action="" method="POST" onsubmit="return validateForm()">
            ...
            <div class="textfield">
                ...
                <div class="error" id="dob-error">Please enter date of birth</div>
                ...
                <input type="text" id="repassword" name="repassword" required placeholder="Confirm password"
                    value="<php echo $user['password']; ?>">
