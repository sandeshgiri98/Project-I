...
<body>
    ...
    if (isset($_SESSION['fake_user'])) {
        ...
        $selectQuery = "SELECT id, name, fake_user, profile_image, last_login_time FROM register WHERE fake_user = '$fakeUserID'";
        $selectExe = mysqli_query($con, $selectQuery);
    ...
    ?>
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                        <a href="../profile/profile_setting.php">
